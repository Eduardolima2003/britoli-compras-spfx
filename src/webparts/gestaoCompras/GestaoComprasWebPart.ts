...
// 1. IMPORTAÇÃO DO PnPjs: Importar a função de setup simplificada
// O caminho deve ser ajustado, pois você está dentro da pasta 'gestaoCompras'
...
  }
  ...
  // 2. CHAMADA NO onInit(): Inicialização da biblioteca PnPjs
  protected onInit(): Promise<void> {
    getSP(this.context); // Usamos 'as any' para evitar problemas de tipagem da versão antiga do PnPjs
